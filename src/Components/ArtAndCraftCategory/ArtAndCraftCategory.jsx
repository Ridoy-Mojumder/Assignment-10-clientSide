    ...
    return (
        <div>
            <div className="max-w-7xl mx-auto my-10 p-10 shadow-xl rounded-lg">
                <h1 className="text-3xl text-center font-semibold text-[#52c9af] mb-6">Art & Craft Category</h1>
                    ...
                    {artAndCraftCategoryData.slice(0, 6).map((item, index) => (
                        <div key={index} className="bg-white rounded-lg shadow-md p-6 flex gap-8">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mb-4">{item.origins.slice(0, 50)}...</p>
                                <div className="">
                                    <span className="text-lg text-[#52c9af] font-bold">${item.keyElements.slice(0, 50)}...</span><br />
